    ...
    async def start_setup(
        ...
        if interaction.user != interaction.guild.owner:
            await interaction.response.send_message(
                "You can't interact with this :D", ephemeral=True
            )
            return
        ...
        await interaction.response.edit_message(
            embed=embed, view=TicketSetupView(self.server_id)
        )
...
class TicketSetupView(discord.ui.View):
    ...
    async def yes(
        ...
        categories = [
            discord.SelectOption(label=category.name, value=category.id)
            for category in interaction.guild.categories
        ]

        await interaction.response.edit_message(
            embed=embed, view=TicketCategoryView(self.server_id, categories)
        )
    ...
    async def skip(
        ...
        await interaction.response.edit_message(
            embed=embed, view=LevelingSetupView(self.server_id)
        )
...
class TicketCategorySelect(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction) -> None:
        ...
        db.guilds.update_one(
            {"id": self.server_id}, {"$set": {"tickets_category": int(category_id)}}
        )
        ...
        while True:
            ...
            try:
                ...
                if role is None:
                    await interaction.followup.send(
                        "You must mention a role.", ephemeral=True
                    )
                    continue
                break
            except:
        ...
        db.guilds.update_one(
            {"id": self.server_id}, {"$set": {"tickets_support_role": role_id}}
        )
...
class LevelingSetupView(discord.ui.View):
    ...
    async def yes(
        ...
        await interaction.response.edit_message(
            embed=embed, view=LevelingShouldAnnounceLevelUp(self.server_id)
        )
    ...
    async def no(
        ...
        db.guilds.update_one(
            {"id": self.server_id}, {"$set": {"should_announce_levelup": False}}
        )
        ...
        await interaction.response.edit_message(
            embed=embed, view=StarboardSetupView(self.server_id)
        )
...
class LevelingShouldAnnounceLevelUp(discord.ui.View):
    ...
    async def yes(
        ...
        db.guilds.update_one(
            {"id": self.server_id}, {"$set": {"should_announce_levelup": True}}
        )
        ...
        await interaction.response.edit_message(
            embed=embed, view=LevelingChannelSelectView(self.server_id, channels)
        )
    ...
    async def yes(
        ...
        while True:
            ...
            try:
                ...
                if channel is None:
                    await interaction.followup.send(
                        "You must mention a channel.", ephemeral=True
                    )
                    continue
                break
            except:
        ...
        await message.delete()
        db.guilds.update_one(
            {"id": self.server_id}, {"$set": {"level_announce_channel": channel_id}}
        )
...
class StarboardSetupView(discord.ui.View):
    ...
    async def yes(
        ...
        db.guilds.update_one(
            {"id": self.server_id}, {"$set": {"starboard.enabled": True}}
        )
        ...
        await message.delete()
        db.guilds.update_one(
            {"id": self.server_id}, {"$set": {"starboard.channel": channel_id}}
        )
        ...
        while True:
            ...
            if not message.content.isdigit():
                await interaction.followup.send(
                    "You must send a number.", ephemeral=True
                )
                continue
        ...
        await message.delete()
        db.guilds.update_one(
            {"id": self.server_id}, {"$set": {"starboard.threshold": threshold}}
        )
        ...
        await interaction.message.edit(
            embed=embed, view=LoggingSetupView(self.server_id)
        )
    ...
    async def no(
        ...
        db.guilds.update_one(
            {"id": self.server_id}, {"$set": {"starboard.enabled": False}}
        )
...
class LoggingSetupView(discord.ui.View):
    ...
    async def yes(
        ...
        await message.delete()
        db.guilds.update_one(
            {"id": self.server_id}, {"$set": {"log_channel": channel_id}}
        )
